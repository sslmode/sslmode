...
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/chunyen91/SSH-SSL/master/iptables.up.rules"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/sslmode/sslmode/master/nginx.conf"
