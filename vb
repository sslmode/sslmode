...
wget -O /etc/default/dropbear "https://raw.githubusercontent.com/macisvpn/inject-69/master/dropbear"
echo "/bin/false" >> /etc/shells
echo "/usr/sbin/nologin" >> /etc/shells
# squid3
apt-get -y install squid3
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/macisvpn/inject-69/master/squid.conf"
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/macisvpn/inject-69/mastersquid.conf"
